jQuery(document).ready(function($){
	...
	$('.xoo-el-otp-deactivate').click(function(){
		$('input[name="_xoo_el_deactivate_otp"]').prop('checked', true);
		$(this).parents('form').find('.button[name="submit"]').trigger('click');
	})

	$('.xoo-el-otp-activate').click(function(){
		$('input[name="_xoo_el_activate_otp"]').prop('checked', true);
		$(this).parents('form').find('.button[name="submit"]').trigger('click');
	})
